...
4. 中文 l10n — **Phase 1–3 done**（+ Subagents 卡片 / Models·Deck agents 屏 / Issues 空态筛选 / Startup 高频 / 转录显示选项）
...
| 已覆盖 | Phase1–3：侧栏/Settings/搜索；Composer/工具栏/会话列表/Activity/Ask；Environment/Doctor；**Subagents 卡片**；**Models + Deck agents 屏**；**Issues 空态与筛选**；**Startup 高频**；**转录显示选项** |
