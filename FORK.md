...
4. 中文 l10n — **Phase 1–2 done**（侧栏 / Settings / Composer / Agent 工具栏 / 会话列表 / Activity / Ask User / Environment / Doctor）
...
| 已覆盖 | Phase1：侧栏 / Settings / 搜索；Phase2：Composer placeholder 与发送、Git 工具栏、会话列表 a11y、Activity、Ask User、Environment、Doctor 主文案 |
| 未覆盖 | Subagents / Skills / Models / Issues 等业务屏大量英文 — 继续按屏扩表 |
