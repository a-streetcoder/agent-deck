...
final class PiSubagentWorktreeServiceTests: XCTestCase {
    ...
    func testPreparePatchWritesBinaryDiffAndListsChangedFiles() async throws {
        ...
        -old
        +new
        diff --git a/pi-manager/AppViewModel.swift b/pi-manager/AppViewModel.swift
        index 3333333..4444444 100644
        --- a/pi-manager/AppViewModel.swift
        +++ b/pi-manager/AppViewModel.swift
        @@ -1 +1 @@
        -old
        +new
        """
        ...
        XCTAssertEqual(patch.changedFiles, ["README.md", "pi-manager/AppViewModel.swift"])
