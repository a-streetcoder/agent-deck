...
description: |
  ...
  haven't seen yet, find relevant files for a task, or gather context before
  planning or implementing. Prefer scout over reading files one-by-one when
  the task involves unfamiliar code, multiple files, or a module you haven't
  touched in this session. Returns a structured context file that other agents
