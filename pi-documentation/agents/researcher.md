...
name: researcher
description: |
  Web research agent. Use when you need current information that isn't in the
  codebase — API docs, library behavior, best practices, ecosystem changes,
  or anything that requires live web searches. Returns a structured research
  brief with sources. Not for codebase exploration (use scout) or plan review
  (use reviewer).
